/**
 * Persistent JSON Database — Kilómetro 0
 * Same API as mockDb but saves to data.json on every write.
...
if(fs.existsSync(DB_FILE)) {
    ...
    data = JSON.parse(JSON.stringify(SEED)); // deep clone
    save();
    console.log('💾 Base de datos inicializada con datos de ejemplo (data.json creado)');
}
